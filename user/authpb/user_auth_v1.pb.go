...
var file_api_protobuf_spec_user_auth_v1_proto_rawDesc = []byte{
	...
	0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xe4, 0x05, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53,
...
var file_api_protobuf_spec_user_auth_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_api_protobuf_spec_user_auth_v1_proto_goTypes = []interface{}{
	...
	(*SendVerificationCodeResponse)(nil),       // 9: user.auth.SendVerificationCodeResponse
	(*VerifyCodeRequest)(nil),                  // 10: user.auth.VerifyCodeRequest
	(*VerifyCodeResponse)(nil),                 // 11: user.auth.VerifyCodeResponse
	(*LogoutRequest)(nil),                      // 12: user.auth.LogoutRequest
	(*LogoutResponse)(nil),                     // 13: user.auth.LogoutResponse
...
var file_api_protobuf_spec_user_auth_v1_proto_depIdxs = []int32{
	...
	10, // 5: user.auth.AuthService.VerifyCode:input_type -> user.auth.VerifyCodeRequest
	8,  // 6: user.auth.AuthService.VerifyUpdatedNumber:input_type -> user.auth.VerifyUpdatedNumberRequest
	12, // 7: user.auth.AuthService.Logout:input_type -> user.auth.LogoutRequest
	1,  // 8: user.auth.AuthService.VerifyAccessToken:output_type -> user.auth.VerifyAccessTokenResponse
	3,  // 9: user.auth.AuthService.VerifyAccessTokenWithRole:output_type -> user.auth.VerifyAccessTokenWithRoleResponse
	5,  // 10: user.auth.AuthService.RefreshToken:output_type -> user.auth.RefreshTokenResponse
	14, // 11: user.auth.AuthService.SendVerificationCode:output_type -> google.protobuf.Empty
	14, // 12: user.auth.AuthService.SendVerificationCodeForRole:output_type -> google.protobuf.Empty
	11, // 13: user.auth.AuthService.VerifyCode:output_type -> user.auth.VerifyCodeResponse
	14, // 14: user.auth.AuthService.VerifyUpdatedNumber:output_type -> google.protobuf.Empty
	13, // 15: user.auth.AuthService.Logout:output_type -> user.auth.LogoutResponse
